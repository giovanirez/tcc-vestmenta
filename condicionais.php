...
<div class="card">
    ...
    <p style="color: var(--text-muted); margin-top: 5px;">Controle de peças enviadas para experimentação dos clientes.</p>
        ...
        <table>
            ...
            <tbody>
                <?php foreach($condicionais as $cond): 
                    ...
                    if($cond['status'] == 'Devolvido') $badgeClass = 'badge'; // cinza padrão
                ?>
                <tr>
                    <td>#<?= $cond['id'] ?></td>
                    ...
                    <td>
                        <button class="btn-icon" title="Finalizar Venda"><i class="fa-solid fa-check text-success"></i></button>
                        <button class="btn-icon" title="Registrar Devolução"><i class="fa-solid fa-rotate-left"></i></button>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
